2. I altered the OS calculations to reduce it to closer to 8 GB (and that's still a lot). My cluster will use Impala, so it's core uses have been calculated.
